# ACoT-VLA: Action Chain-of-Thought for Vision-Language-Action Models 架构学习笔记

## 1. 任务与输入

- Paper: `.study-agent/repos/ACoT-VLA/README.md`
- Repository: `.study-agent/repos/ACoT-VLA`
- Focus: `architecture`
...
- Entry candidates:
  - Candidate 1: `src/openpi/models/acot_vla.py:22 - class MLP`
    - Evidence: `class MLP(nnx.Module):`
  - Candidate 2: `src/openpi/models/model.py:41 - class ModelType`
    - Evidence: `class ModelType(enum.Enum):`
  - Candidate 3: `src/openpi/models/vit.py:31 - class IdentityLayer`
    - Evidence: `class IdentityLayer(nn.Module):`
  - Candidate 4: `src/openpi/models/pi0.py:68 - class Pi0Config`
    - Evidence: `class Pi0Config(_model.BaseModelConfig):`
  - Candidate 5: `src/openpi/models/lora.py:12 - class LoRAConfig`
    - Evidence: `class LoRAConfig:`
  - Candidate 6: `src/openpi/models/gemma.py:45 - class Config`
    - Evidence: `class Config:`
  - Candidate 7: `src/openpi/models/siglip.py:53 - class MlpBlock`
    - Evidence: `class MlpBlock(nn.Module):`
  - Candidate 8: `src/openpi/models/pi0_fast.py:76 - class Pi0FASTConfig`
    - Evidence: `class Pi0FASTConfig(_model.BaseModelConfig):`
- Candidate reason debug:
  - `architecture_entry` :: `src/openpi/models/acot_vla.py` => architecture_entry:core_model_group, architecture_entry:model_namespace, architecture_entry:assembly_filename, architecture_entry:assembly_token:vla, architecture_entry:project_stem_match:acot, architecture_entry:project_stem_match:vla
  - `architecture_entry` :: `src/openpi/models/model.py` => architecture_entry:core_model_group, architecture_entry:model_namespace, architecture_entry:assembly_filename, architecture_entry:assembly_token:model
  - `architecture_entry` :: `src/openpi/models/vit.py` => architecture_entry:core_model_group, architecture_entry:model_namespace
  - `config_entry` :: `src/openpi/training/config.py` => config_entry:config_group, config_entry:python_config, config_entry:training_config, config_entry:config_stem
  - `config_entry` :: `src/openpi/policies/policy_config.py` => architecture_entry:assembly_token:policy, config_entry:config_group, config_entry:python_config, config_entry:policy_config
  - `config_entry` :: `pyproject.toml` => config_entry:config_group
  - `deployment_entry` :: `packages/openpi-client/src/openpi_client/runtime/subscriber.py` => deployment_entry:deployment_group, deployment_entry:runtime_namespace, deployment_entry:deployment_token:client, deployment_entry:deployment_token:runtime, deployment_entry:deployment_token:subscriber
  - `deployment_entry` :: `src/openpi/serving/websocket_policy_server.py` => architecture_entry:assembly_token:policy, deployment_entry:deployment_group, deployment_entry:runtime_namespace, deployment_entry:deployment_token:server, deployment_entry:deployment_token:websocket
  - `deployment_entry` :: `packages/openpi-client/src/openpi_client/runtime/agent.py` => deployment_entry:deployment_group, deployment_entry:runtime_namespace, deployment_entry:deployment_token:client, deployment_entry:deployment_token:runtime
...
- Evidence: `INFERRED`
- Code: `src/openpi/models/acot_vla.py:22 - class MLP`
- Code: `src/openpi/models/model.py:41 - class ModelType`
- Code: `src/openpi/models/vit.py:31 - class IdentityLayer`
...
1. `src/openpi/models/acot_vla.py:22 - class MLP`
2. `src/openpi/models/model.py:41 - class ModelType`
3. `src/openpi/models/vit.py:31 - class IdentityLayer`
4. `src/openpi/models/pi0.py:68 - class Pi0Config`
5. `src/openpi/models/lora.py:12 - class LoRAConfig`
6. `src/openpi/models/gemma.py:45 - class Config`
7. `scripts/train.sh:1 - file train`
8. `scripts/train.py:35 - class CustomFormatter`
9. `src/openpi/training/config.py:1 - file config`
10. `src/openpi/policies/policy_config.py:1 - file policy_config`
11. `packages/openpi-client/src/openpi_client/runtime/subscriber.py:4 - class Subscriber`
12. `src/openpi/serving/websocket_policy_server.py:1 - file websocket_policy_server`
